...
export function HomePage({ navigate }: { navigate: Navigate }) {
  return <>
    ...
    <section className="trusted-by section-pad" aria-labelledby="trusted-by-title">
      <div className="trusted-by-heading">
        <span className="eyebrow">Încredere construită în timp</span>
        <h2 id="trusted-by-title"><strong>Peste 350</strong> de clienți satisfăcuți</h2>
        <p>Companii care au ales serviciile și soluțiile noastre textile.</p>
      </div>
      <div className="company-grid" aria-label="Companii cu care am colaborat">
