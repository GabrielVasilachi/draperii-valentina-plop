...
export function ContactPage() {
  ...
  return (
    <>
      ...
      >
        Scrie-ne sau vizitează salonul din Buiucani pentru a vedea mostrele și a
        discuta proiectul tău.
      </PageHero>
      <section className="contact-wrap section-pad">
        <div className="contact-info">
          ...
          <div className="info-block">
            ...
            <p>
              Sună înainte de vizită pentru a confirma disponibilitatea și ora
              potrivită.
            </p>
          </div>
        </div>
        <div className="contact-form-box">
          {sent ? (
            <div className="success">
              ...
              <h2>Mulțumim!</h2>
              <p>
                Mesajul a fost pregătit. Pentru un răspuns imediat, ne poți suna
                la <a href="tel:+37369212709">+373 69 212 709</a>.
              </p>
            ...
            <form onSubmit={submit}>
              ...
              <p>Completează formularul și revenim pentru detalii.</p>
              ...
              <label>
                ...
                <textarea
                  name="message"
                  rows={5}
                  placeholder="Spune-ne pe scurt despre camere, dimensiuni și stilul dorit..."
                  required
                />
              </label>
              ...
              <small>
                Prin trimitere ești de acord să fii contactat în legătură cu
                solicitarea.
              </small>
            </form>
          )}
